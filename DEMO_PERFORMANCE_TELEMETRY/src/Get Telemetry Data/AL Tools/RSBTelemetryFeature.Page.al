page 53507 "AltERRSB Telemetry Feature"
    PageType = Card;
    ApplicationArea = All;
    UsageCategory = Administration;
    Caption = 'Telemetry Feature';  //ERREA CASE
        ...
        area(Processing)
        {
            action(EmitFeatureTelemetry)
            {
                ...
                begin
                    ...
                    FeatureTelemetry.LogUsage('0000RSB', 'Telemetry feature', 'Run processing');  //ERREA CASE
                end;
            }
        }
    }
